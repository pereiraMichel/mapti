...
<head>
    ...
    <meta name="googlebot" content="map, mapti, michel pereira, desenvolvimento, sistema, software, site, projetos, web, internet, rede">
        ...
        <link rel="shortcut icon" href="<?php echo $pathIco; ?>images/iconMapti.ico">
        <link rel="icon" type="image/png" href="<?php echo $pathIco; ?>iconMapTI24x24.png">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><img src="<?php echo $pathImagens; ?>logoMapTI.png" title="MAP TI" width="230" height="130"></a>
            </div>
            <!-- Collect the nav links, forms, and other content for toggling -->
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li>
                        <a href="about.html">Sobre MAPTI</a>
                    </li>
                    <li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="portfolio-1-col.html">A minha história</a>
                            </li>
                            <li>
                                <a href="portfolio-2-col.html">Os meus cursos</a>
                            </li>
<!--                            <li>
                                <a href="portfolio-3-col.html">Minhas dedicações</a>
                            </li>-->
                            <li>
                                <a href="portfolio-4-col.html">Os meus clientes</a>
                            </li>
<!--                            <li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="blog-home-1.html">Cloud Medical</a>
                            </li>
                            <li>
                                <a href="blog-home-2.html">Cloud Support</a>
                            </li>
                            <li>
                                <a href="blog-post.html">Cloud Football</a>
                            </li>
                        </ul>
                    </li>
<!--                    <li class="dropdown">
